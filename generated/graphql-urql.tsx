...
export type RepositoriesQuery = (
  ...
  & { viewer: (
    { __typename?: 'User' }
    & Pick<User, 'avatarUrl' | 'bio' | 'bioHTML' | 'createdAt' | 'location' | 'login' | 'twitterUsername' | 'url' | 'websiteUrl'>
    & { followers: (
      { __typename?: 'FollowerConnection' }
...
export type RepositoryFragment = (
  { __typename?: 'Repository' }
  & Pick<Repository, 'name' | 'nameWithOwner' | 'url'>
  & { owner: (
    { __typename?: 'Organization' }
...
export const RepositoryFragmentDoc = /*#__PURE__*/ gql`
  ...
  url
    ...
    `;
export const RepositoriesDocument = /*#__PURE__*/ gql`
    query repositories {
  viewer {
    avatarUrl
    bio
...
export function useRepositoriesQuery(options: Omit<Urql.UseQueryArgs<RepositoriesQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<RepositoriesQuery>({ query: RepositoriesDocument, ...options });
};